...
const initialState = {
  ...
  info: {
    ...
    not:  ['not', 'Die Operation wirkt sich auf eine Bitgruppe aus. Hierbei wird jedes Bit umgekehrt. Diese Negation ist an C orientiert. Flags werden bei der Operation nicht gesetzt.'],
